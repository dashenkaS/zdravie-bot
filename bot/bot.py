...
async def send_final_message(update: Update):
    ...
    final_text = (
        ...
        "Галина приглашает Вас на *бесплатную 20-минутную диагностику*.\n"
        "Расскажите о своём запросе - и Галина покажет, "
        "как телесная терапия и ребалансинг могут помочь именно Вам.\n\n"
        "📩 Запишитесь на диагностику личных сообщених: @galastarshinova\n\n"
